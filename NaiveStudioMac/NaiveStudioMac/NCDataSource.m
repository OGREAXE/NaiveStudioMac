...
@interface NCTextViewDataSource()<NSTextViewDelegate>
...
-(void)setText:(NSString *)text{
    [_textView.textStorage setAttributedString:[[NSAttributedString alloc] initWithString:text]];
}
...
-(BOOL)save:(NSError**)error{
    [self.textView.textStorage.string writeToFile:self.linkedStorage atomically:YES encoding:NSUTF8StringEncoding error:error];
    if (*error) {
